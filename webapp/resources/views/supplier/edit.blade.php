...
@section('content')
    <div class="row">
        ...
        <div class="form-group col s12">
            ...
            {!! Form::text('name_supplier', $supplier->name_supplier, ['class' => 'form-control', 'placeholder' => 'Nombre del proveedor', 'required']) !!}
        </div>
        ...
        <div class="form-group col m6">
            ...
            {!! Form::number('phone',$supplier->phone, ['class' => 'form-control', 'placeholder' => '2222222'], 'required') !!}
        </div>

        <div class="form-group col s12">
            {!! Form::label('address_supplier', 'Dirección') !!}
            {!! Form::text('address_supplier', $supplier->address_supplier, ['class' => 'form-control', 'placeholder' => 'Av. avenida # 1234 calle Calle1', 'required']) !!}
        </div>
